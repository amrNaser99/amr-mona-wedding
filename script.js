...
const translations = {
  ar: {
    ...
    heroDate: "الاثنين، 3 أغسطس 2026", heroTime: "الساعة 8:00 مساءً", heroLocation: "دار مناسبات اللوتس، طريق القناطر الخيرية", heroButton: "شاركونا فرحتنا", scrollDown: "انتقل إلى المحتوى التالي",
  ...
  en: {
    ...
    heroDate: "Monday, 3 August 2026", heroTime: "8:00 PM", heroLocation: "Lotus Wedding Hall, Al-Qanater Al-Khayreya Road", heroButton: "Celebrate With Us", scrollDown: "Continue to the next section",
